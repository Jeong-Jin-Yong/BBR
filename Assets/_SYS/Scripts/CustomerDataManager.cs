...
public class CustomerDataManager : MonoBehaviour
{
    ...
    public void OnStartBreadGame()
    {
        ...
        {
            case "moca":
                SceneManager.LoadScene("MochaGameScene");
                break;
            case "white":
                SceneManager.LoadScene("WhiteBreadGameScene");
                break;
            case "sausage":
                SceneManager.LoadScene("SausageGameScene");
                break;
            default:
                Debug.LogWarning("알 수 없는 빵 이름: " + currentBreadTarget);
                break;
        }*/

        Debug.Log(currentBreadTarget);
